"""
A ECU example of how to define settings.
...
@attribute(OpenTap.Display("Example Settings", "A ECU example of how to define settings."))
class ECUSettings(OpenTap.ComponentSettings):
    def __init__(self):
        super().__init__()
