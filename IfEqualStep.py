...
@attribute(OpenTap.Display("If Equal", "Compare two values and run child if true.", "Flow Control"))
#AllowAnyChildAttribute is attribute that allows any child step to attached to this step
@attribute(OpenTap.AllowAnyChild())
class IfEqualsStep(TestStep):
    __clr_attribute__ = [Display("If Values are Equal Step")]
...
#    OutputValue = property(Double, 1.0)\
#        .add_attribute(OpenTap.Display("ValueOut", "", "Output", 0))\
